    ...
    <div className="min-h-screen pt-20 pb-20">
      ...
      <div className="relative h-[280px] overflow-hidden">
        <Image
          ...
          priority
        />
        <div className="absolute inset-0 bg-gradient-to-b from-black/20 via-[#30504F]/90 to-[#30504F]"></div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3 group">
                ...
                <div>
                  ...
                  <a href="mailto:awratechnologies@gmail.com" className="text-white/70 hover:text-[#00FFAB] transition text-sm">awratechnologies@gmail.com</a>
                </div>
              </div>
