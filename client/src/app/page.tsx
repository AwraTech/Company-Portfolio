							...
							<div key={index} className="group relative bg-white/5 border border-white/10 rounded-2xl overflow-hidden hover:border-[#00FFAB]/40 transition-all duration-300 hover:shadow-[0_0_30px_rgba(0,255,171,0.07)]">
								...
								<div className="p-5">
									...
									<div className="flex gap-4 border-t border-white/10 pt-4">
										<a href={member.linkedin} target="_blank" rel="noopener noreferrer" className="group/icon relative flex flex-col items-center text-[#0077B5] hover:text-[#005f8e] hover:scale-110 transition-all duration-200">
											<FaLinkedin size={26} />
											<span className="absolute -top-7 left-1/2 -translate-x-1/2 bg-black/80 text-white text-[10px] px-2 py-0.5 rounded opacity-0 group-hover/icon:opacity-100 transition-opacity whitespace-nowrap">LinkedIn</span>
										</a>
										<a href={member.github} target="_blank" rel="noopener noreferrer" className="group/icon relative flex flex-col items-center text-white hover:text-white/70 hover:scale-110 transition-all duration-200">
											<FaGithub size={26} />
											<span className="absolute -top-7 left-1/2 -translate-x-1/2 bg-black/80 text-white text-[10px] px-2 py-0.5 rounded opacity-0 group-hover/icon:opacity-100 transition-opacity whitespace-nowrap">GitHub</span>
										</a>
										<a href={member.portfolio} target="_blank" rel="noopener noreferrer" className="group/icon relative flex flex-col items-center text-[#00FFAB] hover:text-[#00e69a] hover:scale-110 transition-all duration-200">
											...
											<span className="absolute -top-7 left-1/2 -translate-x-1/2 bg-black/80 text-white text-[10px] px-2 py-0.5 rounded opacity-0 group-hover/icon:opacity-100 transition-opacity whitespace-nowrap">Portfolio</span>
										</a>
									</div>
								</div>
							</div>
